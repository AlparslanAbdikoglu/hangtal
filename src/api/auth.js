...
const WOO_API_BASE_URL = import.meta.env.VITE_WOO_API_URL?.replace('/wc/v3/', ''); // Gets https://your_domain/wp-json/
const WOO_BRIDGE_URL = `${WOO_API_BASE_URL}clerk-woo-bridge/v1/authenticate`; // Appends your custom bridge endpoint

if (!WOO_API_BASE_URL) {
    console.error("VITE_WOO_API_URL is not defined. Cannot determine bridge URL.");
}
