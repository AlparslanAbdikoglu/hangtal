        ...
        <div className="max-w-6xl mx-auto px-4 py-16">
          ...
          <Card className="mb-16 shadow-xl border-0 bg-white/80 backdrop-blur-sm">
            <CardContent className="p-8">
              <h2 className="text-3xl font-bold text-soul-darkBrown mb-6">{t("about.storyTitle")}</h2>
              <div className="grid md:grid-cols-2 gap-8 items-center">
                ...
                <div className="w-full h-64 md:h-80 flex items-center justify-center">
                  <div className="w-full h-full rounded-2xl bg-gradient-to-br from-soul-lightBrown to-soul-brown flex items-center justify-center border-2 border-soul-brown shadow-inner overflow-hidden">
                    {/* Replace src with your about image if available */}
                    <img
              ...
              {values.map((value, index) => (
                ...
                >
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-soul-gray text-sm leading-relaxed">{value.description}</p>
                  </CardContent>
                </Card>
              ))}
            </div>
      ...
      <section className="container py-12 text-center bg-soul-darkBrown">
        ...
        <div className="flex justify-center gap-6">
          {socialLinks.map((link) => (
            ...
            >
              <Button variant="ghost" size="icon" className="text-black hover:text-soul-lightBrown">
                {link.icon}
